          ...
          {user ? (
            <>
              ...
              <Menu as="div" className="relative inline-block text-left">
                ...
                >
                  <Menu.Items className="absolute right-0 z-10 mt-2 p-1 w-40 h-auto origin-top-right rounded-md bg-white border-2 border-blue-500 shadow-lg ring-1 ring-[#333333] ring-opacity-5 focus:outline-none">
                    <div className="py-1">
