      ...
      {loading ? (
        ...
        >
          <div className="absolute inset-0  pt-24 flex justify-center items-center">
            <div className="border px-12 mx-12 mt-36  bg-black bg-opacity-10 border-black rounded-lg">
                      ...
                      <div>
                        <Form.Item>
                          <button
                            type="primary"
                            htmlType="submit"
                            className="bg-[#411EE2] text-white font-bold px-6 py-3 rounded-md hover:bg-blue-800"
                          >
                            Register
                          </button>
                        </Form.Item>
