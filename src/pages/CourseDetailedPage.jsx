...
export default function CourseDetailedPage() {
  ...
  return (
    <>
      <div
        className={`flex flex-col h-fit items-center justify-between ${
          openQuestions ? "hidden" : "block"
        }`}
      >
        {data && (
          <div className="flex flex-col absolute h-fit overflow-y-auto">
            ...
            <div className="bg-white absolute shadow bottom-0 w-screen rounded-t-3xl flex flex-col px-10 py-5 justify-between">
              ...
              <div className="flex justify-between items-end">
                ...
                <button
                  className=" hover:bg-blue-500 border-2 border-blue-500 text-blue-500 px-10 py-2 font-bold hover:text-white rounded-3xl text-lg"
